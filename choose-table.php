  ...
  <body style="background-image:url('images/black.jpg')">
   ...
   <?php include 'template/nav-bar.php'; ?>
    ...
    <section class="home-slider owl-carousel" style="height: 400px;">
      <div class="slider-item" style="background-image: url('images/t3.jpg');" data-stellar-background-ratio="0.5">
                ...
                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                  <div class="row">
                      ...
                      <div class="col-lg-3" style="min-height: 190px">
                        <p style="font-weight: bold; padding: "><h3>Table <?php echo @$i += 1 ?></p></h3>
                        <nav class="menu2">
