...
<?php include 'template/header.php'; ?>
  <body>
    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image: url('images/image_8.jpg');">
      ...
      <div class="slider-item" style="background-image: url('images/blog-06.jpg');">
        <div class="overlay"></div>
        <div class="container">
          <div class="row slider-text align-items-center justify-content-center text-center">
            <div class="col-md-10 col-sm-12 ftco-animate">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 reservation pt-5 px-5">
            ...
            Usually, we're all about getting out more. But these are unprecedented times. <br/><br/>

We intend to do everything we can to support our restaurant partners in what is an extremely challenging time for the industry. Please remember that supporting restaurants does not necessarily mean dining out right now, and we would encourage our users to look out for any opportunity to do this - whether that is through buying vouchers to use at a later date, or ordering delivery. If you choose to spread the word on social media around how you’re supporting restaurants, please do let us know and we’ll continue to amplify these messages wherever we’re able.<br/><br/>

We will of course continue to monitor the situation, and adapt as quickly and as sensitively as possible. In terms of our social media and email, you won’t hear the same messaging from us that you’re used to. Right now, we’re solely focused on what’s best for both diners and restaurants.<br/><br/>
